 ...
 *
 * Available at: https://github.com/jc214809/my-smartthings/
 *
 * Based on:
 *   https://github.com/rogersmj/st-door-alert-after-dark
 *   https://github.com/SmartThingsCommunity/SmartThingsPublic/pull/396/files
 *   https://github.com/nicjansma/smart-things/blob/master/smartapps/nicjansma/garage-door-sunset-monitor.src/garage-door-sunset-monitor.groovy
 *
...
definition(
    ...
    namespace: "jc214809",
    author: "Joel Clark",
    description: "Sends a notification and closes when doors are open after sunset or during time period",
    category: "My Apps",
